...
class KeywordListCellViewModel {
    ...
    let firstKeyword: Driver<Keyword>
    let secondKeyword: Driver<Keyword>
    let thirdKeyword: Driver<Keyword>
    let fourthKeyword: Driver<Keyword>
    let fifthKeyword: Driver<Keyword>
    ...
    let selectedKeywords = BehaviorSubject<[Keyword]>(value: [])
