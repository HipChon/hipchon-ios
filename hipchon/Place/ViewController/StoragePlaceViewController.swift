...
class StoragePlaceViewController: TabmanViewController {
    ...
    let entireVM = CategoryPlaceViewModel(Category(id: nil, name: "전체"))
    let cafePlaceVM = CategoryPlaceViewModel(Category(id: 1, name: "카페"))
    let foodPlaceVM = CategoryPlaceViewModel(Category(id: 2, name: "미식"))
    let activityPlaceVM = CategoryPlaceViewModel(Category(id: 3, name: "활동"))
    let naturalPlaceVM = CategoryPlaceViewModel(Category(id: 4, name: "자연"))
