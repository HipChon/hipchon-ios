...
class PlaceModel: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case name, address, price, imageUrls
    }

    init(name: String, address: String, price: Double, imageUrls: [String]) {
        self.name = name
